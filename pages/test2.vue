<template>
    <div>
      <!-- Hero Start -->
      <section id="test2TopImage" class="bg-half-260"></section><!--end section-->
      <!-- Hero End -->
        ...
        <div class="container">
          <div class="row">
              ...
              <div class="job-profile position-relative">
                <div class="rounded shadow bg-white">
                  <div class="text-center py-5 border-bottom">
                    <img src="~/assets/images/job/Circleci.svg" class="avatar avatar-medium mx-auto rounded-pill d-block" alt="">
                  ...
                  <div class="p-4">
                    ...
                    <ul class="list-unstyled feature-list mb-4">
                      <li class="h5"><i class="mdi mdi-map-marker mdi-18px text-warning mr-2"></i><span class="text-muted">موقعیت :</span> تبریز</li>
                      <li class="h5"><i class="mdi mdi-link-variant mdi-18px text-warning mr-2"></i><span class="text-muted">شرکت :</span> بیمه ایران</li>
                      <li class="h5"><i class="mdi mdi-currency-usd mdi-18px text-warning mr-2"></i><span class="text-muted">درآمد :</span> ماه / 5 میلیون تومان</li>
                      <li class="h5"><i class="mdi mdi-account mdi-18px text-warning mr-2"></i><span class="text-muted">تعداد کارمندان :</span> 200</li>
                    </ul>
                    <a href="javascipt:void(0)" data-toggle="modal" data-target="#ApplyNow" class="btn btn-block btn-primary">انجام دهید</a>
                  </div>
                </div>
            ...
            <div class="col-lg-8 col-md-7 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
              <div class="ml-md-4">
                <h4>درباره ما :</h4>
                <p class="text-muted">تقریبا هیچ شغلی از نیاز به توسعه نرم افزار با کیفیت مصون نیست. عمل ساختن نرم افزار با کیفیت ساختمان و ارسال سریع آن به موتور اصلی ایجاد ارزش در شرکت ها در تمام صنایع تبدیل شده است.  به تیمها اجازه می دهد تا با خودکار کردن مراحل ساخت ، آزمایش و تحویل ، کدی را که به آنها اعتماد دارند را آزاد کنند. هزاران شرکت پیشرو ، از جمله سامسونگ .</p>
                <p class="text-muted">تقریبا هیچ شغلی از نیاز به توسعه نرم افزار با کیفیت مصون نیست. عمل ساختن نرم افزار با کیفیت ساختمان و ارسال سریع آن به موتور اصلی ایجاد ارزش در شرکت ها در تمام صنایع تبدیل شده است.  به تیمها اجازه می دهد تا با خودکار کردن مراحل ساخت ، آزمایش و تحویل ، کدی را که به آنها اعتماد دارند را آزاد کنند. هزاران شرکت پیشرو ، از جمله سامسونگ .</p>
                <p class="text-muted mb-0">تقریبا هیچ شغلی از نیاز به توسعه نرم افزار با کیفیت مصون نیست. عمل ساختن نرم افزار با کیفیت ساختمان و ارسال سریع آن به موتور اصلی ایجاد ارزش در شرکت ها در تمام صنایع تبدیل شده است.  به تیمها اجازه می دهد تا با خودکار کردن مراحل ساخت ، آزمایش و تحویل ، کدی را که به آنها اعتماد دارند را آزاد کنند. هزاران شرکت پیشرو ، از جمله سامسونگ .</p>

                <h4 class="mt-lg-5 mt-4">به تیم بپیوندید :</h4><div class="contact_map mt-60">

                <p class="text-muted mb-0">در سال 2011 شروع به کار کردیم ، ما به بیش از 200 کارمند در سراسر جهان افزایش یافته ایم. دفتر مرکزی آن در سانفرانسیسکو است ، ما دفترهایی در لندن ، توکیو ، تورنتو ، بوستون و دنور داریم که اعضای تیم در 50+ شهر و 13 کشور مشغول به کار هستند..</p>
                ...
                <div class="row">
                  ...
                  <div class="col-12 mt-4 pt-2">
                    <a href="page-jobs.html" class="btn btn-primary">نمایش همه شغل ها <i class="mdi mdi-chevron-right"></i></a>
                  </div>
                </div>
              </div>
              </div><!--end col-->
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group position-relative">
                      ...
                      <input name="email" id="email" type="email" class="form-control pl-5" required placeholder="ایمیل :">
                    </div>
                  </div><!--end col-->
                  <div class="col-md-6">
                    <div class="form-group position-relative">
                      ...
                      <input name="number" id="number" type="number" class="form-control pl-5" required placeholder="شماره تلفن. :">
                    </div>
                  </div><!--end col-->
                  <div class="col-md-6">
                    <div class="form-group position-relative">
                  ...
                  <div class="col-md-12">
                    <div class="form-group position-relative">
                      ...
                      <textarea name="comments" id="comments" rows="4" class="form-control pl-5" required placeholder="توضیحاتی در مورد شغل :"></textarea>
                    </div>
                  </div><!--end col-->
                  <div class="col-md-12">
                    <div class="form-group position-relative">
...
<style scoped>
  ...
  #test2TopImage{
    background: url("../assets/images/job/company.jpg") center center;
  }
