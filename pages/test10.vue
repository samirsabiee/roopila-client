              ...
              <div class="col-lg-12 text-center">
                <div class="page-next-level">
                  ...
                  <ul class="page-next d-inline-block bg-white shadow p-2 pl-4 pr-4 rounded mb-0">
                    ...
                    <li>
                      <span class="text-uppercase text-primary font-weight-bold">جزئیات کار</span>
                    </li>
                  </ul>
                </div>
              </div>  <!--end col-->
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 text-center">
            <img src="~/assets/images/work/single.jpg" class="img-fluid rounded" alt="">
          </div>
          ...
          <div class="col-md-10 mt-4 pt-2">
            ...
            <div class="row">
              <div class="col-md-6 mt-4 pt-2">
                <img src="~/assets/images/work/2.jpg" class="img-fluid rounded" alt="">
              </div>
            ...
            <div class="row">
              <div class="col-md-6 mt-4 pt-2">
                <div class="work-details rounded bg-light p-4">
                  <h5 class="title border-bottom pb-3 mb-3">اطلاعات پروژه :</h5>
                  <ul class="list-unstyled mb-0">
                    ...
                    <li class="mt-3">
                      <b>موقعیت :</b>
                      <span>ایران، شاهین دژ خیابان 17</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div class="shadow rounded mt-4 pt-2">
              <div class="p-4">
                <h4 class="page-title pb-3">نظرات :</h4>
                  ...
                  <li class="comment-desk mt-4">
                    ...
                    <div class="commentor">
                      ...
                      <div class="overflow-hidden d-block">
                        ...
                        <small class="text-muted">6 بهمن 1398 در ساعت 01:25 بعد از ظهر</small>
                      </div>
                    </div>
                    <div class="mt-3">
                  ...
                  <li class="comment-desk mt-4">
                    ...
                    <div class="commentor">
                      ...
                      <div class="overflow-hidden d-block">
                        ...
                        <small class="text-muted">7 بهمن 1398 در ساعت 01:25 بعد از ظهر</small>
                      </div>
                    </div>
                    <div class="mt-3">
                      <p class="text-muted font-italic p-3 bg-light rounded">" تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه "</p>
                  ...
                  <li class="comment-desk mt-4">
                    ...
                    <div class="commentor">
                      ...
                      <div class="overflow-hidden d-block">
                        ...
                        <small class="text-muted">8 بهمن 1398 در ساعت 01:25 بعد از ظهر</small>
                      </div>
                    </div>
                    <div class="mt-3">
                      <p class="text-muted font-italic p-3 bg-light rounded">" تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه "</p>
