              ...
              <div class="col-lg-12 text-center">
                <div class="page-next-level">
                  ...
                  <ul class="page-next d-inline-block bg-white shadow p-2 pl-4 pr-4 rounded mb-0">
                    ...
                    <li>
                      <span class="text-uppercase text-primary font-weight-bold">خدمات</span>
                    </li>
                  </ul>
                </div>
              </div>  <!--end col-->
          ...
          <div class="col-lg-6 col-md-6 mt-4 pt-2">
            <div class="work-container position-relative rounded">
              <div class="position-relative overflow-hidden">
                ...
                <div class="content">
                  <a href="javascript:void(0)" class="title text-white d-block font-weight-bold">چشم انداز تغییر</a>
                  <small class="text-light">استدیو</small>
                </div>
                <div class="client">
          ...
          <div class="col-lg-6 col-md-6 mt-4 pt-2">
            <div class="work-container position-relative shadow rounded">
              <div class="position-relative overflow-hidden">
                ...
                <div class="overlay-work"></div>
                <div class="content">
                  <a href="javascript:void(0)" class="title text-white d-block font-weight-bold">خبر های رنگی</a>
          ...
          <div class="col-lg-6 col-md-6 mt-4 pt-2">
            <div class="work-container position-relative shadow rounded">
              <div class="position-relative overflow-hidden">
                ...
                <div class="overlay-work"></div>
                <div class="content">
                  <a href="javascript:void(0)" class="title text-white d-block font-weight-bold">لوازم آرایشی اسپا</a>
          ...
          <div class="col-lg-6 col-md-6 mt-4 pt-2">
            <div class="work-container position-relative shadow rounded">
              <div class="position-relative overflow-hidden">
                ...
                <div class="overlay-work"></div>
                <div class="content">
                  <a href="javascript:void(0)" class="title text-white d-block font-weight-bold">قهوه ریزر</a>
